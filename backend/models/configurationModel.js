...
const configurationSchema = new mongoose.Schema(
  {
    ...
    frequence_deche: { type: Number, required: true },
    temps_collect_dechet: { type: Number, required: true },
    seuil_securite: { type: Number, required: true },
    frequence_controle_securite: { type: Number, required: true },
    niveau_critique_securite: { type: Number, required: true }
  },
  {
    timestamps: true,
  }
